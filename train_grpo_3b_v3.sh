...
# =============================================================================
# Search-R1 GRPO — Qwen2.5-3B v3
# Resume from v1 step 100 checkpoint (0.20 EM) with:
#   - search_r1 parser + stop strings (actual retrieval)
#   - kl_loss_coef=0.005 (moderate, between v1=0.001 and v2=0.01)
#   - entropy_coeff=0.001 (gentle nudge, not dominating)
#   - All flash_attn optimizations (~30-40s/step)
# =============================================================================
...
echo "============================================="
echo "v3: Resume from step 100 with search fix"
echo "kl_coef=0.005, entropy_coeff=0.001"
echo "============================================="
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    2>&1 | tee "logs/${EXPERIMENT_NAME}-v3.log"
