...
# =============================================================================
# Search-R1 GRPO Training — Qwen2.5-3B (OPTIMIZED)
# Resumes from checkpoint with:
#   1. flash_attn 2.8.3 → use_remove_padding=true + flash_attention_2
#   2. Higher micro batch sizes (16/32)
#   3. max_response_length=512 (original Search-R1 used 500)
#   4. search_r1 tool parser (parses <search> tags → actual retrieval)
# Expected: ~150-180s/step (vs ~390s without optimizations)
# =============================================================================
...
EXPERIMENT_NAME="nq-grpo-qwen2.5-3b-0508"

echo "============================================="
echo "OPTIMIZED Training: $EXPERIMENT_NAME"
echo "Resuming from latest checkpoint"
echo "flash_attn=2.8.3, remove_padding=true, search_r1 parser"
echo "============================================="
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    2>&1 | tee "logs/${EXPERIMENT_NAME}-optimized.log"
